...
const encodedParameters = web3.eth.abi.encodeParameters(['uint256', 'string'], Object.values(rawParameters));
  ...
  for (const { mode, Token } of TOKENS) {
    describe(`using ${Token._json.contractName}`, function () {
      ...
      it('Voting with params is properly supported', async function () {
        ...
        const weight = web3.utils.toBN(web3.utils.toWei('7')).sub(rawParameters.uintParam);
        ...
        expectEvent(tx, 'CountParams', { ...rawParameters });
