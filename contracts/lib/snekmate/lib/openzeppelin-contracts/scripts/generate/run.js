...
const needsLinter = new Set(['utils/structs/EnumerableMap.sol']);
...
for (const [file, template] of Object.entries({
  ...
  generateFromTemplate(file, template, './contracts/', needsLinter.has(file));
}
...
for (const [file, template] of Object.entries({
  ...
  generateFromTemplate(file, template, './test/', needsLinter.has(file));
}
