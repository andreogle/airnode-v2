...
describe('AccessManager', function () {
  ...
  describe('getters', function () {
    ...
    describe('#getRoleAdmin', function () {
      const roleId = 5_234_907n;

      it('returns the role admin', async function () {
        const adminId = 789_433n;
    ...
    describe('#getSchedule', function () {
      beforeEach('set role and calldata', async function () {
        const functionRestricted = this.target.fnRestricted.getFragment().selector;
        this.caller = this.user;
        this.role = { id: 493_590n };
        await this.manager.$_setTargetFunctionRole(this.target, functionRestricted, this.role.id);
        await this.manager.$_grantRole(this.role.id, this.caller, 0, 1); // nonzero execution delay

        this.calldata = this.target.interface.encodeFunctionData(functionRestricted, []);
    ...
    describe('#hashOperation', function () {
      it('returns an operationId', async function () {
        const arguments_ = [this.user, this.other, '0x123543'];
        expect(await this.manager.hashOperation(...arguments_)).to.equal(hashOperation(...arguments_));
      });
    });
  });
  ...
  describe('admin operations', function () {
    ...
    describe('subject to a delay', function () {
      describe('#labelRole', function () {
        describe('restrictions', function () {
          beforeEach('set method and args', function () {
            const arguments_ = [123_443, 'TEST'];
            const method = this.manager.interface.getFunction('labelRole(uint64,string)');
            this.calldata = this.manager.interface.encodeFunctionData(method, arguments_);
          });
      ...
      describe('#setRoleAdmin', function () {
        describe('restrictions', function () {
          beforeEach('set method and args', function () {
            const arguments_ = [93_445, 84_532];
      ...
      describe('#setGrantDelay', function () {
        describe('restrictions', function () {
          beforeEach('set method and args', function () {
            const arguments_ = [984_910, time.duration.days(2)];
      ...
      describe('#setTargetAdminDelay', function () {
        describe('restrictions', function () {
          beforeEach('set method and args', function () {
            const arguments_ = [this.other.address, time.duration.days(3)];
    ...
    describe('not subject to a delay', function () {
      ...
      describe('#setTargetClosed', function () {
        describe('restrictions', function () {
          beforeEach('set method and args', function () {
            const arguments_ = [this.other.address, true];
      ...
      describe('#setTargetFunctionRole', function () {
        describe('restrictions', function () {
          beforeEach('set method and args', function () {
            const arguments_ = [this.other.address, ['0x12345678'], 443_342];
      ...
      describe('role admin operations', function () {
        const ANOTHER_ADMIN = 0xD_EA_DC_0D_E1n;
        const ANOTHER_ROLE = 0xD_EA_DC_0D_E2n;
        ...
        describe('#grantRole', function () {
          describe('restrictions', function () {
            beforeEach('set method and args', function () {
              const arguments_ = [ANOTHER_ROLE, this.other.address, 0];
        ...
        closed() {
          it('reverts as AccessManagerUnauthorizedCall', async function () {
            ...
            await expect(schedule())
              ...
              .withArgs(this.caller, this.target, this.calldata.slice(0, 10));
          });
        },
        open: {
          callerIsTheManager: {
