...
describe('SignedMath', function () {
  ...
  describe('average', function () {
    it('is correctly calculated with various input', async function () {
      for (const x of [ethers.MinInt256, -57_417n, -42_304n, -4n, -3n, 0n, 3n, 4n, 42_304n, 57_417n, ethers.MaxInt256]) {
        for (const y of [ethers.MinInt256, -57_417n, -42_304n, -5n, -2n, 0n, 2n, 5n, 42_304n, 57_417n, ethers.MaxInt256]) {
