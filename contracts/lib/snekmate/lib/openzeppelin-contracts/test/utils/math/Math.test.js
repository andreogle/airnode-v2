...
const testCommutative = (function_, lhs, rhs, expected, ...extra) =>
  Promise.all([
    expect(function_(lhs, rhs, ...extra)).to.eventually.deep.equal(expected),
    expect(function_(rhs, lhs, ...extra)).to.eventually.deep.equal(expected),
  ]);
  ...
  describe('sqrt', function () {
    it('rounds down', async function () {
      for (const rounding of RoundingDown) {
        ...
        await expect(this.mock.$sqrt(999_999n, rounding)).to.eventually.equal(999n);
        await expect(this.mock.$sqrt(1_000_000n, rounding)).to.eventually.equal(1000n);
        await expect(this.mock.$sqrt(1_000_001n, rounding)).to.eventually.equal(1000n);
        await expect(this.mock.$sqrt(1_002_000n, rounding)).to.eventually.equal(1000n);
        await expect(this.mock.$sqrt(1_002_001n, rounding)).to.eventually.equal(1001n);
    ...
    it('rounds up', async function () {
      for (const rounding of RoundingUp) {
        ...
        await expect(this.mock.$sqrt(4n, rounding)).to.eventually.equal(2n);
        await expect(this.mock.$sqrt(144n, rounding)).to.eventually.equal(12n);
        await expect(this.mock.$sqrt(999_999n, rounding)).to.eventually.equal(1000n);
        await expect(this.mock.$sqrt(1_000_000n, rounding)).to.eventually.equal(1000n);
        await expect(this.mock.$sqrt(1_000_001n, rounding)).to.eventually.equal(1001n);
        await expect(this.mock.$sqrt(1_002_000n, rounding)).to.eventually.equal(1001n);
        await expect(this.mock.$sqrt(1_002_001n, rounding)).to.eventually.equal(1001n);
        await expect(this.mock.$sqrt(ethers.MaxUint256, rounding)).to.eventually.equal(
          340_282_366_920_938_463_463_374_607_431_768_211_456n,
        );
      }
    });
  });
    ...
    describe('log256', function () {
      it('rounds down', async function () {
        for (const rounding of RoundingDown) {
          ...
          await expect(this.mock.$log256(65_535n, rounding)).to.eventually.equal(1n);
          await expect(this.mock.$log256(65_536n, rounding)).to.eventually.equal(2n);
          await expect(this.mock.$log256(65_537n, rounding)).to.eventually.equal(2n);
      ...
      it('rounds up', async function () {
        for (const rounding of RoundingUp) {
          ...
          await expect(this.mock.$log256(65_535n, rounding)).to.eventually.equal(2n);
          await expect(this.mock.$log256(65_536n, rounding)).to.eventually.equal(2n);
          await expect(this.mock.$log256(65_537n, rounding)).to.eventually.equal(3n);
