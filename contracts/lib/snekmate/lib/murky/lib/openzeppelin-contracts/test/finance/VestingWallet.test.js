...
async function fixture() {
  ...
  const vestingFunction = timestamp => min(amount, (amount * (timestamp - start)) / duration);

  return { mock, duration, start, beneficiary, schedule, vestingFn: vestingFunction, env: environment };
}
